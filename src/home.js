...
export default class Home {
    ...
    createInstaElements() {
        this.instaElements = [
        new Component(15.15, 7.15, "black", 171.38, 17.69, this.ctx, "other"),
        new Component(13.320090701290027, 6.001171088144297, Background1, 172.1428108924363, 18.363964847607136, this.ctx, "image"),
        ...
        new Component(1.6894334194043434, 0.4990748962192262, Cloud2, 172.514881423219, 23.79242703845068, this.ctx, "image"),
